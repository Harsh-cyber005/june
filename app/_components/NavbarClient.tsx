...
function NavbarClient() {
    ...
    return (
        <section className='w-full h-full justify-center items-center md:hidden flex relative'>
            ...
            <div className={`w-[80%] min-w-[200px] flex flex-col justify-center items-start absolute bottom-0 right-0 bg-[#ffffffe4] shadow-2xl z-[100] ${isOpen?"translate-y-[100%] opacity-100":"opacity-0"} duration-200`}>
                <div className='hover:bg-[white] w-full p-5 cursor-pointer'>
